...
public class PlaygroundFragment extends Fragment {
        ...
        adapter.setOnItemCLickListener(new RecyclerViewItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                if (data != null) {
                    ...
                    bundle.putString(Constant.PLAYGROUND_NUM, brief[position][6]);
    ...
    private void initDataSet() {
        ...
        dataSet.add(new PlaygroundItemModel(R.drawable.yizhaoweide, "一兆韦德健身俱乐部", tag_Booleans_7, "金昌北路75号"));
    }
    ...
    private String[][] brief = {{"outdoor", "plastic", "circle", "all day", "free", "兰州大学创建于1909年，其前身是清末新政期间设立的甘肃法政学堂，开启了西北高等教育的先河。其田径场免费对市民开放，是跑步的好场所", "0"},
            {"indoor", "water", "1.4-1.8m", "7:00-20:30", "￥2600/year\n￥30/time", "兰海游泳馆隶属于甘肃兰海商贸责任公司，集游泳健身，悠闲娱乐为一体", "09318418301"},
            {"school", "mixed", "circle", "all day", "free", "甘肃中医药大学是2015年经教育部批准由成立于1978年的甘肃中医学院更名而成，坐落在甘肃省省会兰州市。学校为社会培养输送了3万余名合格的中医药及相关专业人才，为甘肃医疗卫生事业和经济社会发展做出了应有的贡献。", "0"},
            {"indoor", "yoga", "coach provided", "10:00-20:00", "22/time", "瑜伽姿势运用古老而易于掌握的技巧，改善人们生理、心理、情感和精神方面的能力，是一种达到身体、心灵与精神和谐统一的运动方式，包括调身的体位法、调息的呼吸法、调心的冥想法等，以达至身心的合一。", "1389337445"},
            {"indoor", "mixed", "wood", "8:00-20:00", "20/h", "新建的大型保龄球馆，设备一流、环境舒适，与原有的健身馆、羽毛球馆、乒乓球馆、篮球馆、台球厅等构成了兰州地段最佳的全民健身场所。", "09319929910"},
            {"outdoor", "mixed", "circle", "all day", "free", "体育公园是主题公园的一种类型，园内把体育健身场地和生态园林环境巧妙地融为一体，是体育锻炼、健身休闲型的公共场所！", "0"},
            {"indoor", "floor", "mix", "7:00-20:00", "￥3000/year", "新开的健身房，走高端路线，环境很好，附有教练", "0931879088"}};
}
